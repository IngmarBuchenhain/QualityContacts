...
namespace QualityContacts.ServiceInterfaces.Services
{
    ...
    public interface IContactValidator
    {
        ...
        /// </summary>
        /// <param name="contactCandidate">Contact information.</param>
        public IValidationResult Validate(string contactCandidate);

        /// <summary>
        /// Validates whether an <see cref="IContact"/> is valid.
        /// </summary>
